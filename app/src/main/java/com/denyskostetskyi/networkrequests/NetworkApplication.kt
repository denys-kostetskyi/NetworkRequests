...
import com.denyskostetskyi.networkrequests.data.repository.WeatherForecastRepositoryImpl
...
class NetworkApplication : Application() {
    ...
    override fun onCreate() {
        ...
        weatherForecastRepository = WeatherForecastRepositoryImpl(apiService, mapper)
    }
